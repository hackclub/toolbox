export default [{
        ...
        items: [{
            ...
            {
                name: "Toppings",
                description: "Add some flavor to your site with CSS and earn toppings for your Ice Cream & Boba!",
    ...
    },
    {
        ...
        items: [{
            ...
            {
                name: "Workshops",
                description: "Learn programming and create fun projects with short, in-depth workshops",
                icon: "idea",
                external: true,
    ...
    },
    {
        ...
        items: [{
            ...
            {
                name: "Spaces",
                description: "Create, share, and deploy websites or other apps instantly with GIT integration for clubs.",
            ...
            },
            {
                ...
                description: "Be part of a fun, technically-diverse and supportive community on Slack",
                icon: "slack",
                external: true,
